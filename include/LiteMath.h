...
#ifdef M_PI
#undef M_PI // same if we have such macro somewhere else ...
#endif

#ifdef M_1_PI
#undef M_1_PI // same if we have such macro somewhere else ...
#endif

#ifdef min 
#undef min // if we on windows, need thid due to macro definitions in windows.h; same if we have such macro somewhere else.
#endif

#ifdef max
#undef max // if we on windows, need thid due to macro definitions in windows.h; same if we have such macro somewhere else.
#endif
